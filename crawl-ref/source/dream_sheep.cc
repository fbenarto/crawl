...
const int Dream_Sheep::MIN_DREAM_SUCCESS_POWER = 25;

void Dream_Sheep::_sheep_message(int num_sheep, int sleep_pow, actor& foe)
{
    string message;
...
void Dream_Sheep::_dream_sheep_sleep(monster& mons, actor& foe)
{
