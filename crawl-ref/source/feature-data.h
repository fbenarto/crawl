...
PORTAL_ENTRANCE(DNGN_ENTER_COCYTUS, "gateway to the Frozen Wastes of Cocytus", "enter_cocytus", LIGHTCYAN),
PORTAL_ENTRANCE(DNGN_ENTER_TARTARUS, "gateway to Tartarus, the Decaying Netherworld", "enter_tartarus", MAGENTA),
